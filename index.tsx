    ...
    async function loadTestProfile() {
      ...
      if (saved) {
        ...
        setTestProfile({
          ...
          isTeamLead: parsed.role.includes('Team Lead'),
          canSeeAllTeams: parsed.role === 'Owner',
          canSeeTeamData: parsed.role.includes('Team Lead') || parsed.role === 'Owner',
        });
      }
    }
    loadTestProfile();
    ...
    <GradientBackground>
      ...
      <UserProfileSelector
        ...
        onSelectProfile={(newProfile) => {
          setTestProfile({
            ...newProfile,
            isOwner: newProfile.role === 'Owner',
            isTeamLead: newProfile.role.includes('Team Lead'),
            canSeeAllTeams: newProfile.role === 'Owner',
            canSeeTeamData: newProfile.role.includes('Team Lead') || newProfile.role === 'Owner',
          });
